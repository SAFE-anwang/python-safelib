...
class CBloomFilter(safe.core.serialize.Serializable):
    ...
    def insert(self, elem):
        ...
        """
        if isinstance(elem, safe.core.COutPoint):
            elem = elem.serialize()
    ...
    def stream_deserialize(cls, f):
        vData = bytearray(safe.core.serialize.BytesSerializer.stream_deserialize(f))
        (nHashFuncs,
         nTweak,
         nFlags) = CBloomFilter.__struct.unpack(safe.core.ser_read(f, CBloomFilter.__struct.size))
    ...
    def stream_serialize(self, f):
        safe.core.serialize.BytesSerializer.stream_serialize(self.vData, f)
